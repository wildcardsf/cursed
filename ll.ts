...
export const keyname = (c: number): Deno.UnsafePointerView => symbols.keyname(c) as Deno.UnsafePointerView;
...
export const longname = (): Deno.UnsafePointerView => symbols.longname() as Deno.UnsafePointerView;
...
export const slk_label = (n: number): Deno.UnsafePointerView => symbols.slk_label(n) as Deno.UnsafePointerView;
...
export const termname = (): Deno.UnsafePointerView => symbols.termname() as Deno.UnsafePointerView;
...
export const tigetstr = (str: Uint8Array): Deno.UnsafePointerView => symbols.tigetstr(str) as Deno.UnsafePointerView;
export const putp = (string: Uint8Array): number => symbols.putp(string) as number;
export const tparm = (string: Uint8Array): Deno.UnsafePointerView => symbols.tparm(string) as Deno.UnsafePointerView;
...
export const keybound = (code: number, count: number): Deno.UnsafePointerView => symbols.keybound(code, count) as Deno.UnsafePointerView;
export const curses_version = (): Deno.UnsafePointerView => symbols.curses_version() as Deno.UnsafePointerView;
...
export const _traceattr = (newmode: number): Deno.UnsafePointerView => symbols._traceattr(newmode) as Deno.UnsafePointerView;
export const _traceattr2 = (bufnum: number, newmode: number): Deno.UnsafePointerView => symbols._traceattr2(bufnum, newmode) as Deno.UnsafePointerView;
export const _nc_tracebits = (): Deno.UnsafePointerView => symbols._nc_tracebits() as Deno.UnsafePointerView;
export const _tracechar = (ch: number): Deno.UnsafePointerView => symbols._tracechar(ch) as Deno.UnsafePointerView;
export const _tracechtype = (ch: number): Deno.UnsafePointerView => symbols._tracechtype(ch) as Deno.UnsafePointerView;
export const _tracechtype2 = (bufnum: number, ch: number): Deno.UnsafePointerView => symbols._tracechtype2(bufnum, ch) as Deno.UnsafePointerView;
export const _tracecchar_t = (ch: any): Deno.UnsafePointerView => symbols._tracecchar_t(ch) as Deno.UnsafePointerView;
export const _tracecchar_t2 = (bufnum: number, ch: any): Deno.UnsafePointerView => symbols._tracecchar_t2(bufnum, ch) as Deno.UnsafePointerView;
export const trace = (tracelevel: number): any => symbols.trace(tracelevel) as any;
export const _nc_visbuf = (buf: Uint8Array): Deno.UnsafePointerView => symbols._nc_visbuf(buf) as Deno.UnsafePointerView;
